...
bearer_token = "AAAAAAAAAAAAAAAAAAAAAPAbnQEAAAAAzwiM9MS1%2BtwZ8gHcd5OAPX70Oeg%3DjrmMUT67JEcJTYbjUGuKMsGInVo9RouB7sXw58r2IntLlQFeAs"
...
#            for tweet in client.hydrate(news.tweet_ids):
            #for tweet in t.hydrate(news.tweet_ids):
            for tweet in client.tweet_lookup(news.tweet_ids):
