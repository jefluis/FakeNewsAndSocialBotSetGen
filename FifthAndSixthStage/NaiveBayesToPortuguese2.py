...
# Treinar o modelo Naive Bayes com as features originais
clf_reduced = MultinomialNB()
...
joblib.dump(clf_reduced, 'modelo_NaiveBayes_reduced_features.pkl')
 
#===============================================================================
# '''
# Finding Important Features in NaiveBayes
# '''
...
# plt.ylabel('Features')
# plt.title("Visualizing Important Features (NaiveBayes)Modelo com dados básicos do Twitter")
# plt.legend()
# plt.show()
# print('+++++++++++++++++++++++++++++++')
#===============================================================================
...
# Treinar o modelo NaiveBayes com as features originais
clf = MultinomialNB()
...
joblib.dump(clf, 'modelo_NaiveBayes_original_features.pkl')
...
First, you need to create a NaiveBayes model.
...
# Treinar o modelo NaiveBayes com um conjunto expandido de features
...
joblib.dump(clf_expanded, 'modelo_NaiveBayes_expanded_features.pkl')
...
# Salvar o modelo treinado com features expandidas
joblib.dump(clf_VAD_Tang, 'modelo_NaiveBayes_VAD_Tang_features.pkl')
