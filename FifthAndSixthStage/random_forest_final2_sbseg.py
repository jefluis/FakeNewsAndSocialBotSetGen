...
# Jeferson begin
cursor_SemDominancia_randomforest  = db.cursor()
cursor_users_from_setGen_randomforest  = db.cursor()
...
sql_users_from_setGen = 'select u.* from users_from_setgen as u inner join ( select  userid, count(tweetid) as Mensagens from TweetsOfLabeledNews group by UserId having Mensagens > 25) as T2 where T2.userid = u.userid and u.v_media > 0'
#Jeferson End
...
# Jeferson begin
cursor_SemDominancia_randomforest.execute(sql_SemDominancia)
datas_SemDominancia = cursor_SemDominancia_randomforest.fetchall() 

cursor_users_from_setGen_randomforest.execute(sql_users_from_setGen)
datas_users_from_setGen = cursor_users_from_setGen_randomforest.fetchall() 
...
#Jeferson Begin
print('***********************************************')
print('Query somente VA')
print(datas_SemDominancia)

print('***********************************************')
print('Query users_from_setGen')
print(datas_users_from_setGen)
#Jeferso End

print('***********************************************')
print('Query com somente dados de perfil do twitter')
print(datas2)

print('***********************************************')
print('Query com 50 dimensões do Tang')
print(datas3)
...
for tupla in datas:
    n = n + 1
    newtupla = tupla
    n1 = ConvertDatetimetoTimestamp(tupla[1])
    n2 = ConvertDatetimetoTimestamp(tupla[2])
    # Como não podemos modificar os elementos de uma tupla, devemos substituí-la por uma tupla diferente
    newtupla = (tupla[0], n1, n2) + tupla[3:]
...
#Alterando tupla de cada conta (convertendo datetimes em timestamps)
d=0
lista_SemDominancia_posix_dates = []
for tupla_SemDominancia in datas_SemDominancia:
    d = d + 1
    newtupla_SemDominancia = tupla_SemDominancia
    d1 = ConvertDatetimetoTimestamp(tupla_SemDominancia[1])
    d2 = ConvertDatetimetoTimestamp(tupla_SemDominancia[2])
    # Como não podemos modificar os elementos de uma tupla, devemos substituí-la por uma tupla diferente
    newtupla_SemDominancia = (tupla_SemDominancia[0], d1, d2) + tupla_SemDominancia[3:]
    lista_SemDominancia_posix_dates.append(newtupla_SemDominancia)
print('***********************************************')  
print('Lista com VA')  
print(lista_SemDominancia_posix_dates)
print('Número de usuários =',d) 


#Alterando tupla de cada conta (convertendo datetimes em timestamps)
users_from_setGen=0
lista_users_from_setGen_posix_dates = []
for tupla_users_from_setGen in datas_users_from_setGen:
    users_from_setGen = users_from_setGen + 1
    newtupla_users_from_setGen = tupla_users_from_setGen
    users_from_setGen1 = ConvertDatetimetoTimestamp(tupla_users_from_setGen[1])
    users_from_setGen2 = ConvertDatetimetoTimestamp(tupla_users_from_setGen[2])
    # Como não podemos modificar os elementos de uma tupla, devemos substituí-la por uma tupla diferente
    newtupla_users_from_setGen = (tupla_users_from_setGen[0], users_from_setGen1, users_from_setGen2) + tupla_users_from_setGen[3:]
    lista_users_from_setGen_posix_dates.append(newtupla_users_from_setGen)
print('***********************************************')  
print('Lista users_from_setGen')  
print(lista_users_from_setGen_posix_dates)
print('Número de usuários =',users_from_setGen) 
...
for tupla2 in datas2:
    m = m + 1
    newtupla2 = tupla2
    m1 = ConvertDatetimetoTimestamp(tupla2[1])    
    # Como não podemos modificar os elementos de uma tupla, devemos substituí-la por uma tupla diferente
    newtupla2 = (tupla2[0], m1) + tupla2[2:]
    lista2_posix_dates.append(newtupla2)
print('***********************************************')  
print('Lista somente perfil do twitter')  
...
for tupla3 in datas3:
    p = p + 1
    newtupla3 = tupla3
    p1 = ConvertDatetimetoTimestamp(tupla3[1])   
    # Como não podemos modificar os elementos de uma tupla, devemos substituí-la por uma tupla diferente
    # Jeferson Begin
    #newtupla3 = (tupla3[0], b1) + tupla3[2:]
    newtupla3 = (tupla3[0], p1) + tupla3[2:]
    # Jeferson End
    lista3_posix_dates.append(newtupla3)
print('***********************************************')  
print('Lista com 50 dimensões do Tang')  
...
#Jeferson begin
dados_SemDominancia = np.array(lista_SemDominancia_posix_dates)

dados_users_from_setGen = np.array(lista_users_from_setGen_posix_dates)
#Jeferson end
...
print('***********************************************')  
print('Lista com VA') 
print(dados_SemDominancia)


print('***********************************************')  
print('Lista com Users_from_setGen') 
print(dados_users_from_setGen)
# Jeferson End


print('***********************************************')  
print('Lista somente perfil Twitter') 
print(dados2)
...
print('Número dimensões do array dados_SemDominancia =',dados_SemDominancia.ndim)
print('Número dimensões do array dados_users_from_setGen =',dados_users_from_setGen.ndim)
...
print('Número elementos do array dados_SemDominancia =',dados_SemDominancia.size)
print('Número elementos do array dados_users_from_setGen =',dados_users_from_setGen.size)
...
print('comprimento do array "dados_SemDominancia" =',len(dados_SemDominancia))
print('comprimento do array "dados_users_from_setGen" =',len(dados_users_from_setGen))
...
# Criando um DataFrame de um dado dataset (no caso, um numpy array da lista modificada de tuplas)
data_SemDominancia=pd.DataFrame({
    'CreatedAt':dados_SemDominancia[:,1],
   # 'CollectedAt':dados_SemDominancia[:,2],
    'NumberOfFollowings':dados_SemDominancia[:,3],
    'NumberOfFollowers':dados_SemDominancia[:,4],    
    'NumberOfTweets':dados_SemDominancia[:,5],
    'LengthOfScreenName':dados_SemDominancia[:,6],
    'LenDescrInUseProf':dados_SemDominancia[:,7],    
    'V_media':dados_SemDominancia[:,8],
    'A_media':dados_SemDominancia[:,9],
    #'D_media':dados_SemDominancia[:,10],
    'V_1quartil':dados_SemDominancia[:,11],
    'A_1quartil':dados_SemDominancia[:,12],
    #'D_1quartil':dados_SemDominancia[:,13],    
    'V_mediana':dados_SemDominancia[:,14],
    'A_mediana':dados_SemDominancia[:,15],
    #'D_mediana':dados_SemDominancia[:,16],    
    'V_3quartil':dados_SemDominancia[:,17],
    'A_3quartil':dados_SemDominancia[:,18],
    #'D_3quartil':dados_SemDominancia[:,19],    
    'V_desviopadrao':dados_SemDominancia[:,20],
    'A_desviopadrao':dados_SemDominancia[:,21],
    #'D_desviopadrao':dados_SemDominancia[:,22],
    'V_amplitude':dados_SemDominancia[:,23],
    'A_amplitude':dados_SemDominancia[:,24],
    #'D_amplitude':dados_SemDominancia[:,25],
    'type':dados_SemDominancia[:,27],
})
data_SemDominancia.head()


# Criando um DataFrame de um dado dataset (no caso, um numpy array da lista modificada de tuplas)
data_users_from_setGen=pd.DataFrame({
    'CreatedAt':dados_users_from_setGen[:,1],
   # 'CollectedAt':dados_users_from_setGen[:,2],
    'NumberOfFollowings':dados_users_from_setGen[:,3],
    'NumberOfFollowers':dados_users_from_setGen[:,4],    
    'NumberOfTweets':dados_users_from_setGen[:,5],
    'LengthOfScreenName':dados_users_from_setGen[:,6],
    'LenDescrInUseProf':dados_users_from_setGen[:,7],    
    'V_media':dados_users_from_setGen[:,8],
    'A_media':dados_users_from_setGen[:,9],
    #'D_media':dados_users_from_setGen[:,10],
    'V_1quartil':dados_users_from_setGen[:,11],
    'A_1quartil':dados_users_from_setGen[:,12],
    #'D_1quartil':dados_users_from_setGen[:,13],    
    'V_mediana':dados_users_from_setGen[:,14],
    'A_mediana':dados_users_from_setGen[:,15],
    #'D_mediana':dados_users_from_setGen[:,16],    
    'V_3quartil':dados_users_from_setGen[:,17],
    'A_3quartil':dados_users_from_setGen[:,18],
    #'D_3quartil':dados_users_from_setGen[:,19],    
    'V_desviopadrao':dados_users_from_setGen[:,20],
    'A_desviopadrao':dados_users_from_setGen[:,21],
    #'D_desviopadrao':dados_users_from_setGen[:,22],
    'V_amplitude':dados_users_from_setGen[:,23],
    'A_amplitude':dados_users_from_setGen[:,24],
    #'D_amplitude':dados_users_from_setGen[:,25],
    'type':dados_users_from_setGen[:,27],
})
data_users_from_setGen.head()
#Jeferson end
...
#####
# avaliar se deve retirar no x3 o update control e o type
X3=data3[['CreatedAt', 'NumberOfFollowings', 'NumberOfFollowers', 'NumberOfTweets', 'LengthOfScreenName', 'LenDescrInUseProf', 'Update_Control', 'type', 'd1_media', 'd2_media', 'd3_media', 'd4_media', 'd5_media', 'd6_media', 'd7_media', 'd8_media', 'd9_media','d10_media', 'd11_media', 'd12_media', 'd13_media', 'd14_media', 'd15_media', 'd16_media', 'd17_media', 'd18_media', 'd19_media', 'd20_media', 'd21_media', 'd22_media', 'd23_media', 'd24_media', 'd25_media', 'd26_media', 'd27_media', 'd28_media', 'd29_media', 'd30_media', 'd31_media', 'd32_media', 'd33_media', 'd34_media', 'd35_media', 'd36_media', 'd37_media', 'd38_media', 'd39_media', 'd40_media', 'd41_media', 'd42_media', 'd43_media', 'd44_media', 'd45_media', 'd46_media', 'd47_media', 'd48_media', 'd49_media', 'd50_media', 'd1_1quartil', 'd2_1quartil', 'd3_1quartil', 'd4_1quartil', 'd5_1quartil', 'd6_1quartil', 'd7_1quartil', 'd8_1quartil', 'd9_1quartil', 'd10_1quartil', 'd11_1quartil', 'd12_1quartil', 'd13_1quartil', 'd14_1quartil', 'd15_1quartil', 'd16_1quartil', 'd17_1quartil', 'd18_1quartil', 'd19_1quartil', 'd20_1quartil', 'd21_1quartil', 'd22_1quartil', 'd23_1quartil', 'd24_1quartil', 'd25_1quartil', 'd26_1quartil', 'd27_1quartil', 'd28_1quartil', 'd29_1quartil', 'd30_1quartil', 'd31_1quartil', 'd32_1quartil', 'd33_1quartil', 'd34_1quartil', 'd35_1quartil', 'd36_1quartil', 'd37_1quartil', 'd38_1quartil', 'd39_1quartil', 'd40_1quartil', 'd41_1quartil', 'd42_1quartil', 'd43_1quartil', 'd44_1quartil', 'd45_1quartil', 'd46_1quartil', 'd47_1quartil', 'd48_1quartil', 'd49_1quartil', 'd50_1quartil', 'd1_mediana', 'd2_mediana', 'd3_mediana', 'd4_mediana', 'd5_mediana', 'd6_mediana', 'd7_mediana', 'd8_mediana', 'd9_mediana', 'd10_mediana', 'd11_mediana', 'd12_mediana', 'd13_mediana', 'd14_mediana', 'd15_mediana', 'd16_mediana', 'd17_mediana', 'd18_mediana', 'd19_mediana', 'd20_mediana', 'd21_mediana', 'd22_mediana', 'd23_mediana', 'd24_mediana', 'd25_mediana', 'd26_mediana', 'd27_mediana', 'd28_mediana', 'd29_mediana', 'd30_mediana', 'd31_mediana', 'd32_mediana', 'd33_mediana', 'd34_mediana', 'd35_mediana', 'd36_mediana', 'd37_mediana', 'd38_mediana', 'd39_mediana', 'd40_mediana', 'd41_mediana', 'd42_mediana', 'd43_mediana', 'd44_mediana', 'd45_mediana', 'd46_mediana', 'd47_mediana', 'd48_mediana', 'd49_mediana', 'd50_mediana', 'd1_3quartil', 'd2_3quartil', 'd3_3quartil', 'd4_3quartil', 'd5_3quartil', 'd6_3quartil', 'd7_3quartil', 'd8_3quartil', 'd9_3quartil', 'd10_3quartil', 'd11_3quartil', 'd12_3quartil', 'd13_3quartil', 'd14_3quartil', 'd15_3quartil', 'd16_3quartil', 'd17_3quartil', 'd18_3quartil', 'd19_3quartil', 'd20_3quartil', 'd21_3quartil', 'd22_3quartil', 'd23_3quartil', 'd24_3quartil', 'd25_3quartil', 'd26_3quartil', 'd27_3quartil', 'd28_3quartil', 'd29_3quartil', 'd30_3quartil', 'd31_3quartil', 'd32_3quartil', 'd33_3quartil', 'd34_3quartil', 'd35_3quartil', 'd36_3quartil', 'd37_3quartil', 'd38_3quartil', 'd39_3quartil', 'd40_3quartil', 'd41_3quartil', 'd42_3quartil', 'd43_3quartil', 'd44_3quartil', 'd45_3quartil', 'd46_3quartil', 'd47_3quartil', 'd48_3quartil', 'd49_3quartil', 'd50_3quartil', 'd1_desviopadrao', 'd2_desviopadrao', 'd3_desviopadrao', 'd4_desviopadrao', 'd5_desviopadrao', 'd6_desviopadrao', 'd7_desviopadrao', 'd8_desviopadrao', 'd9_desviopadrao', 'd10_desviopadrao', 'd11_desviopadrao', 'd12_desviopadrao', 'd13_desviopadrao', 'd14_desviopadrao', 'd15_desviopadrao', 'd16_desviopadrao', 'd17_desviopadrao', 'd18_desviopadrao', 'd19_desviopadrao', 'd20_desviopadrao', 'd21_desviopadrao', 'd22_desviopadrao', 'd23_desviopadrao', 'd24_desviopadrao', 'd25_desviopadrao', 'd26_desviopadrao', 'd27_desviopadrao', 'd28_desviopadrao', 'd29_desviopadrao', 'd30_desviopadrao', 'd31_desviopadrao', 'd32_desviopadrao', 'd33_desviopadrao', 'd34_desviopadrao', 'd35_desviopadrao', 'd36_desviopadrao', 'd37_desviopadrao', 'd38_desviopadrao', 'd39_desviopadrao', 'd40_desviopadrao', 'd41_desviopadrao', 'd42_desviopadrao', 'd43_desviopadrao', 'd44_desviopadrao', 'd45_desviopadrao', 'd46_desviopadrao', 'd47_desviopadrao', 'd48_desviopadrao', 'd49_desviopadrao', 'd50_desviopadrao', 'd1_amplitude', 'd2_amplitude', 'd3_amplitude', 'd4_amplitude', 'd5_amplitude', 'd6_amplitude', 'd7_amplitude', 'd8_amplitude', 'd9_amplitude', 'd10_amplitude', 'd11_amplitude', 'd12_amplitude', 'd13_amplitude', 'd14_amplitude', 'd15_amplitude', 'd16_amplitude', 'd17_amplitude', 'd18_amplitude', 'd19_amplitude', 'd20_amplitude', 'd21_amplitude', 'd22_amplitude', 'd23_amplitude', 'd24_amplitude', 'd25_amplitude', 'd26_amplitude', 'd27_amplitude', 'd28_amplitude', 'd29_amplitude', 'd30_amplitude', 'd31_amplitude', 'd32_amplitude', 'd33_amplitude', 'd34_amplitude', 'd35_amplitude', 'd36_amplitude', 'd37_amplitude', 'd38_amplitude', 'd39_amplitude', 'd40_amplitude', 'd41_amplitude', 'd42_amplitude', 'd43_amplitude', 'd44_amplitude', 'd45_amplitude', 'd46_amplitude', 'd47_amplitude', 'd48_amplitude', 'd49_amplitude', 'd50_amplitude']]  # Features
y=data['type']  # Labels
y2=data2['type']  # Labels
y3=data3['type']  # Labels

X_SemDominancia=data_SemDominancia[['CreatedAt','NumberOfFollowings', 'NumberOfFollowers', 'NumberOfTweets', 'LengthOfScreenName', 'LenDescrInUseProf', 'V_media', 'A_media', 'V_1quartil', 'A_1quartil', 'V_mediana', 'A_mediana', 'V_3quartil', 'A_3quartil', 'V_desviopadrao', 'A_desviopadrao', 'V_amplitude', 'A_amplitude']]  # Features
y_SemDominancia=data_SemDominancia['type']  # Labels

X_users_from_setGen=data_users_from_setGen[['CreatedAt','NumberOfFollowings', 'NumberOfFollowers', 'NumberOfTweets', 'LengthOfScreenName', 'LenDescrInUseProf', 'V_media', 'A_media', 'V_1quartil', 'A_1quartil', 'V_mediana', 'A_mediana', 'V_3quartil', 'A_3quartil', 'V_desviopadrao', 'A_desviopadrao', 'V_amplitude', 'A_amplitude']]  # Features
...
X_SemDominancia_train, X_SemDominancia_test, y_SemDominancia_train, y_SemDominancia_test = train_test_split(X_SemDominancia, y_SemDominancia, test_size=0.2) # 70% training and 30% test
...
clf_SemDominancia=RandomForestClassifier(n_estimators=100)
...
clf_SemDominancia.fit(X_SemDominancia_train,y_SemDominancia_train)
...
y_SemDominancia_pred=clf_SemDominancia.predict(X_SemDominancia_test)
...
print("Accuracy with 18 features withou dominance=",metrics.accuracy_score(y_SemDominancia_test, y_SemDominancia_pred))
...
feature_SemDominancia_names =['CreatedAt','NumberOfFollowings', 'NumberOfFollowers', 'NumberOfTweets', 'LengthOfScreenName', 'LenDescrInUseProf', 'V_media', 'A_media', 'V_1quartil', 'A_1quartil', 'V_mediana', 'A_mediana', 'V_3quartil', 'A_3quartil', 'V_desviopadrao', 'A_desviopadrao', 'V_amplitude', 'A_amplitude']
...
feature_SemDominancia_imp = pd.Series(clf_SemDominancia.feature_importances_,index=feature_SemDominancia_names).sort_values(ascending=False)

print('Principais features - Modelo com VAD')
print(feature_imp)
print('+++++++++++++++++++++++++++++++')

print('Principais features - Modelo com VA')
print(feature_SemDominancia_imp)
print('+++++++++++++++++++++++++++++++')
...
print('Principais features - Modelo com 50 dimensões Tang')
print(feature3_imp)
print('++++++++++++FIM++++++++++++++++')
...
# Creating a bar plot
sns.barplot(x=feature_SemDominancia_imp, y=feature_SemDominancia_imp.index)
# Add labels to your graph
plt.xlabel('Feature Importance Score ')
plt.ylabel('Features')
plt.title("Visualizing Important Features _SemDominancia")
plt.legend()
plt.show()
print('+++++++++++++++++++++++++++++++')
...
plt.xlabel('Feature Importance Score')
plt.ylabel('Features')
plt.title("Visualizing Important Features com perfil Twitter")
plt.legend()
plt.show()
...
plt.xlabel('Feature Importance Score')
plt.ylabel('Features')
plt.title("Visualizing Important Features + 50 dimensões tang")
plt.legend()
plt.show()
print('+++++++++++++++++++++++++++++++')
...
joblib.dump(clf_SemDominancia, 'modelo_randomforest_semdominancia.pkl')

# Carregar o modelo usando joblib
modelo_carregado = joblib.load('modelo_randomforest_semdominancia.pkl')

# Fazer previsões na base de dados de usuários set gen
previsao_usuarios = modelo_carregado.predict(X_users_from_setGen)

print('***********************************************')  
print('Classificaçaõ usuários') 
print(previsao_usuarios)
