# -*- coding: utf-8 -*-
"""
Created on Thu Aug 16 07:36:48 2018
...
try:
    ...
    sql_content_polluters_tweets = 'SELECT UserID FROM legitimate_users_tweets'
    ...
    for user in users:
        ...
        def sqlUpdatedQuery (z):        
             return ("SELECT * FROM legitimate_users WHERE UserID = "+ str(z))                        
