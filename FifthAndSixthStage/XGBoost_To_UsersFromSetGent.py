...
clf_vad_features = joblib.load('modelo_XGBoost_original_features.pkl')
clf_reduced_features = joblib.load('modelo_xgboost_reduced_features.pkl')
clf_tang_features = joblib.load('modelo_XGBoost_expanded_features.pkl')
clf_vad_tang_features = joblib.load('modelo_XGBoost_VAD_Tang_features.pkl')
...
#    update_query = f"UPDATE users_from_setgen SET prediction_vad={prediction_original_features}, prediction_twitter_features={prediction_reduced_features}, prediction_Tang={prediction_expanded_features}, prediction_vad_Tang={prediction_vad_tang_features} WHERE UserID={user_id}"
    update_query = f"UPDATE users_from_setgen SET prediction_xgboost_vad={prediction_original_features}, prediction_xgboost_twitter_features={prediction_reduced_features}, prediction_xgboost_Tang={prediction_expanded_features}, prediction_xgboost_vad_Tang={prediction_vad_tang_features} WHERE UserID={user_id}"
