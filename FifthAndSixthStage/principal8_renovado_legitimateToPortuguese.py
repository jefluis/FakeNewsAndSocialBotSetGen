...
def build_query(valence, arousal, dominance, tweet_id):
    return f"UPDATE legitimate_users_tweets_original_pt SET Val = {valence}, Aro = {arousal}, Dom = {dominance}, Control1 = 1 WHERE TweetID = {tweet_id}"
...
try:        
    ...
    sql_teste_tweets = 'SELECT * FROM legitimate_users_tweets_original_pt WHERE Control1=0'
    ...
    tweets = cursor_legitimate_users_tweets.fetchall()
