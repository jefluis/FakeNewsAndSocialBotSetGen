...
def queryTweetbyuser (u):   
    return ("SELECT TweetID, Val, Aro, Dom FROM content_polluters_tweets_original_pt WHERE UserID = "+ str(u))
...
def buildQuery (user, 
    ...
    return ("UPDATE content_pollutersToPortuguese SET V_media = "+ str(v_media)+", A_media = "+ str(a_media)+", D_media = "+ str(d_media)+
