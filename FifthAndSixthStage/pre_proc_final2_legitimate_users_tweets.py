# -*- coding: utf-8 -*-
"""
Created on Sun Jun 14 00:43:41 2020
...
try:
    ...
    sql_teste_tweets = 'SELECT * FROM legitimate_users_tweets_original'
      
    #Construindo função para receber variáveis e concatená-las com SQL
    def buildQuery (twl, i):        
        return ("UPDATE legitimate_users_tweets_original SET Tweet_limpo = '"+ str(twl)+"' WHERE TweetID = "+ str(i))
